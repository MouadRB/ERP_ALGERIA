package com.dz.erp.pim.logistics.infrastructure.event;
...
public class LogisticsEventPublisher implements LogisticsEventPort {
    ...
    public void publish(String et, String ai, Object ev) {
        pub.publish(ev);
        outbox.save("ProductLogistics", ai, et, json.writeValueAsString(ev));
    }
}
